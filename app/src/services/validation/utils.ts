 ...
 */
export function calculateDeltaE(color1: RGBColor, color2: RGBColor): number {
 ...
 */
export function calculateDeltaEFromStrings(color1: string, color2: string): number | null {
